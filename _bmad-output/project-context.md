...
- `@mycscompanion/execution` — Fly Machine config, typed SSE events (discriminated union), benchmark runner
...
| Env vars (custom) | `MCC_` prefix | `MCC_FLY_API_TOKEN` (third-party keep standard: `ANTHROPIC_API_KEY`) |
